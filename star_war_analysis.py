...
# using check on columns 33 to 36 to get the following counts 
#Male: 549 (42%)
#Female: 497 (58%)
...
#1.1: comparing popularity among espisodes(by whether have respondents watched it), no segmenting
...
#1.2: comparing popularity among espisodes, segmenting by gender
...
#1.3: comparing popularity among espisodes, segmenting by education level 
...
#1.4: comparing popularity among espisodes, segmenting by income level 
f, ax = plt.subplots(figsize = (10,5), sharey = True)
ind = np.arange(6)
...
#1.5: comparing popularity among espisodes, segmenting by age
f, ax = plt.subplots(figsize = (10,5), sharey = True)
ind = np.arange(6)
...
#2: comparing ranking among espisodes given by respondents
